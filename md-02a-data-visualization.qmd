...
The two fonctions shows the same things but the graphic looks clearer and nicer with geom_histogram function.
...
The first and second numbers of seq argument define the beginning and end of the x-axis. While, the last one define the size of histogram.

```{r}
ggplot(data = gapminder_2007,
       mapping = aes(x = lifeExp,
                     fill = continent)) +
  geom_histogram(col="grey30", breaks= seq(30,85,2.5))
```
